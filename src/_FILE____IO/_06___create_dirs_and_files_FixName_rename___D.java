...
//
//
public class _06___create_dirs_and_files_FixName_rename___D {
...
//public class Aufgabe3_ErstelleOrdnerDatei {
//    public static void main(String[] args) throws IOException {
//        File ordner = new File("daten");
//        if (!ordner.exists()) {
//            ordner.mkdir(); // Ordner anlegen, falls nicht vorhanden
//        }
//
//        File datei = new File(ordner, "essen.txt");
//        PrintWriter writer = new PrintWriter(new FileWriter(datei));
//
//        writer.println("Pizza");
//        writer.println("Sushi");
//        writer.println("Spaghetti");
//        writer.println("Lasagne");
//
//        writer.close();
//        System.out.println("Lieblingsessen gespeichert in daten/essen.txt");
//    }
//}