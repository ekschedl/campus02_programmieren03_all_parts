...
public class MainClientMitHintergrund___chat_speichern_append {
        ...
        try {
            ...
            while ((empfangen = in.readLine()) != null) {
                ...
                if (System.in.available() > 0) {
                    ...
                    // Wenn "exit", sauber beenden
                    if (eingabe.equalsIgnoreCase("exit")) {
                        out.write("Client beendet den Chat.");
                        out.newLine();
                        out.flush();
                        logWriter.write("Client hat den Chat beendet.");
                        logWriter.newLine();
                        logWriter.flush();
